  ...
  grunt.initConfig({
    ...
    copy: {
      dist: {
        ...
        { expand: true, cwd: 'bower_components/bootstrap/dist/fonts/', src: '**', dest: '<%= yeoman.dist %>/fonts' },
        ...
        { expand: true, cwd: 'bower_components/bootstrap-datepicker/dist/css/', src: ['bootstrap-datepicker3.css'], dest: '<%= yeoman.dist %>'},
